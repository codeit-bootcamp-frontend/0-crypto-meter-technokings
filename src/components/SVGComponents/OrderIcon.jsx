...
/**
 * @props {sortState}
 * @example sortState="none"      //default
 *          sortState="ascend"  //ascending order
 *          sortState="descnd" //descending order
 */
  ...
  return (
    ...
    >
      <path
        ...
        fill={sortState === "ascend" ? colors.gray7 : colors.gray4}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill={sortState === "descend" ? colors.gray7 : colors.gray4}
      />
    </S.Svg>
  );
};
